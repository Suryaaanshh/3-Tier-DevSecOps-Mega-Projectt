    ...
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          ...
          <div>
            <h1 className="brand-title">PBL</h1>
            <p className="nav-subtitle">Project Based Learning</p>
          </div>
        </div>
      </header>
      ...
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          ...
          <ul className="social-links">
            <li><a className="sidebar-btn" href="https://www.linkedin.com/in/suryansh-kashyap-878706387//" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
